...
public class DateCheck {
    ...
    public DateCheck(int monthInt, int day, int year) {
        setDate(monthInt, day, year);
    }

    public DateCheck(String monthString, int day, int year) {
        setDate(monthString, day, year);
    }

    public DateCheck(int year) {
        setDate(1, 1, year);
    }

    public DateCheck(DateCheck aDate) {
    ...
    public boolean equals(DateCheck otherDate) {
        if (otherDate == null)
            return false;
        else
    ...
    public boolean precedes(DateCheck otherDate) {
